...
namespace SwAIvyn.Data
{
    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        /// <summary>
        /// Gets or sets the Prompts DbSet.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the UploadDocuments DbSet.
        /// </summary>
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UploadDocument>()
                .HasKey(ud => ud.Id);
            modelBuilder.Entity<UploadDocument>()
                .HasIndex(ud => ud.ContentHash);
            modelBuilder.Entity<UploadDocument>()
                .HasIndex(ud => new { ud.Status, ud.UploadedAt });
            modelBuilder.Entity<UploadDocument>()
                .HasIndex(ud => ud.Category);

            // DocumentChunk
            modelBuilder.Entity<DocumentChunk>()
                .HasKey(dc => dc.Id);
            modelBuilder.Entity<DocumentChunk>()
                .HasOne(dc => dc.UploadDocument)
                .WithMany()
                .HasForeignKey(dc => dc.UploadDocumentId)
                .OnDelete(DeleteBehavior.Cascade);
            modelBuilder.Entity<DocumentChunk>()
