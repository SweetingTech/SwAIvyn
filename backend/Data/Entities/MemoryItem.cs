...
public DateTime CreatedAt { get; set; }
        ...
        /// <summary>
        /// Gets or sets the target vector store for this memory item.
        /// Determines which vector database (Neo4j or Weaviate) should be used.
        /// </summary>
        public VectorTarget TargetStore { get; set; } = VectorTarget.Neo4j;
